...
class TutorialGhost extends SpriteComponent with HasGameRef, CollisionCallbacks {
  ...
  final BehaviorSubject<GhostPositionModel?> ghostPositionNotifierTutorial = BehaviorSubject.seeded(null);
  ...
  Future<void> addGhostMotion() async{
    ...
    ghostPositionNotifierTutorial.add(ghostPositionModel);
